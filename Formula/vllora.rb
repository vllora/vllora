class Vllora < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/vllora/vllora/releases/download/v0.4.0-prerelease-10/ai-gateway-macos-aarch64"
      sha256 "5e6ed0da4e008d950d5fc66dc12fe5f1d42165fc9b408cefa7cd4964e77de5dc"  # Run: shasum -a 256 ai-gateway-aarch64
    else
      url "https://github.com/vllora/vllora/releases/download/v0.4.0-prerelease-10/ai-gateway-macos-x86_64"
      sha256 "f31497f451e2546e58aa1e6f58ea3abcb22e57fe27014876a10c1cc29ae160a3"  # Run: shasum -a 256 ai-gateway-x86_64
    end
  end
  on_linux do
    if Hardware::CPU.arm?
      # url "https://github.com/vllora/vllora/releases/download/v0.4.0-prerelease-10/ai-gateway-linux-aarch64"
      # sha256 "placeholder_linux_arm_sha256"  # Will be updated by CI
    else
      url "https://github.com/vllora/vllora/releases/download/v0.4.0-prerelease-10/ai-gateway-linux-x86_64"
