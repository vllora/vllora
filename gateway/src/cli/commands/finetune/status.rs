//! Pure read of journal + analysis; print Next: /finetune-<verb>.
//!
//! Track: B | Feature: 003-cli-pipeline-verbs | Design: parent §5.7
...
pub async fn handle(_db_pool: DbPool, _args: Args) -> Result<(), crate::CliError> {
    ...
    unimplemented!("TODO Track B — 003-cli-pipeline-verbs — status");
}
