...
use crate::metadata::models::providers::{
    DbInsertProvider, DbProvider, DbUpdateProvider,
};
...
pub trait ProviderService {
    ...
    fn get_provider_by_name(&self, provider_name: &str) -> Result<Option<DbProvider>, DatabaseError>;
    ...
    fn update_provider(&self, provider_id: &str, update: DbUpdateProvider) -> Result<(), DatabaseError>;
    ...
    fn list_providers_with_credential_status(&self, project_id: Option<&str>) -> Result<Vec<ProviderInfo>, DatabaseError>;
}
...
mod tests {
    ...
    fn test_provider_info_from_db_provider() {
        ...
        assert_eq!(provider_info.description, Some("Test description".to_string()));
