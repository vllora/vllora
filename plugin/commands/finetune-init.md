---
description: |
  scaffolds finetune-project/, creates gateway workflow.
  Triggers: "init workflow", "scaffold", "start a fine-tune".
  Preconditions: none.
allowed-tools: Bash
---
...
## When to use
scaffolds finetune-project/, creates gateway workflow. Preconditions: none.

## Steps
1. Verify preconditions via `vllora finetune status`.
2. Shell out: `vllora finetune init "<objective>"`
