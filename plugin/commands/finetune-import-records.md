---
description: |
  skips sources+plan+generate; imports pre-built records.
  Triggers: "import records", "I have training data".
...
## When to use
skips sources+plan+generate; imports pre-built records. Preconditions: init done.
